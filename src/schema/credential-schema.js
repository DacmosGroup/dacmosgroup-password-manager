// ============================================================
// Dacmos Password Manager — Schema de Credencial (v0.5.1)
// Normalización de schema de credencial. Chokepoint único para
// decisiones de schema — NO pertenece al engine de crypto.
//
