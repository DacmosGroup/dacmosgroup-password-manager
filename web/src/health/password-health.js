// ============================================
// Dacmos Password Manager — Motor de Salud (PWA)
// Fork de src/health/password-health.js para la PWA.
// Sin cambios de lógica — idéntico al original.
// Solo el path de importación difiere (web/ como raíz de servicio).
// ============================================
